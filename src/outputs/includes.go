...
import (
	...
	_ "github.com/elastic/beats/libbeat/outputs/rabbitmq" // load support output codec
	_ "github.com/elastic/beats/libbeat/outputs/redis"
	_ "github.com/elastic/beats/libbeat/outputs/rocketmq"
	_ "github.com/elastic/beats/libbeat/publisher/queue/memqueue"
	_ "github.com/elastic/beats/libbeat/publisher/queue/spool" // load supported output plugins
)
